...
export const metadata: Metadata = {
  title: "Error | The Room",
  description: "Error page for testing",
};
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
        <h1 className="mb-8 font-semibold text-title-md sm:text-title-lg xl:text-title-2xl text-[var(--app-text-primary-color)]">
          ERROR
        </h1>
        ...
        <p className="mt-10 mb-6 text-sm sm:text-base text-[var(--app-text-secondary-color)]">
