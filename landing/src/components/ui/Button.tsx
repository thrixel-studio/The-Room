...
export function Button({
  ...
  const baseStyles =
    "inline-flex items-center justify-center gap-2 font-medium rounded-xl transition-colors [&_svg]:[transition:inherit] disabled:opacity-50 disabled:cursor-not-allowed";
